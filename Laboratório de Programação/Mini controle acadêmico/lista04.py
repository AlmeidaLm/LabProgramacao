class disci:
    def __init__(self,codigo,nomi,semestri,carghr,hora):
        self.codigo = codigo
        self.nomi = nomi
...
def cadastra_disciplina(listcod):
    ...
    return o.codigo,o.nomi,o.semestri,profis,aluns,o.carghr,o.hora
